...
const conferenceData = {
  papers: [
    ...
    },
    {
      ...
      image: "/img/computacion-cuantica.jpg"
    }
  ],
  sessions: [
    {
      ...
      presentations: [
        {
          ...
          presenterImage: "/img/ramon-lopez.jpg"
        }
      ]
    },
    {
      ...
      presentations: [
        {
          ...
          presenterImage: "/img/Kate-Crawford.jpg"
        }
      ]
    }
  ],
    ...
    <div class="max-w-7xl mx-auto py-8 px-8 mt-24">
      <div v-if="currentSection === 'inicio'" class="space-y-8">
        <div class="flex flex-col items-center md:flex-row">
          ...
          <img src="/img/estudiante-ciencia.png" alt="Cientifico"
